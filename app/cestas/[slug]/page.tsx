...
import { formatPrice, parseImages, parseDetailedDescription, getWhatsAppLink, cn } from '@/lib/utils'
...
export default function ProductPage() {
  ...
  const currentPrice = variant === 'PACK' && product.wholesalePackPrice != null
  ...
  const discountAmount = hasDiscount ? Number(product.originalPrice) - currentPrice : 0
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-8">
            ...
            <div>
              <ProductImages 
                ...
                selectedVariantImages={variantImages}
              />
                  ...
                  <div className="flex flex-wrap gap-2">
                    {product.variants.map((v) => (
                      <button
                        ...
                        className={cn(
                          "group min-w-[140px] px-4 py-2.5 rounded-xl border text-left text-sm font-medium transition-all duration-200",
                      ...
                      >
                        <span className="block font-semibold leading-none">{v.name}</span>
                        <span className="mt-1 block text-xs text-gray-500 group-disabled:text-gray-500">
                          {v.stock <= 0
                            ? 'Esgotado'
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center gap-2 text-sm text-gray-600">
                    <Package className="h-4 w-4" />
                    <span>Estoque disponível: {currentStock}</span>
                  </div>
                </div>
